...
REVISION = (
    ...
    " common ancestor. With the magic value :PRE-COMMIT:, Darker expects the revision"
    " range from the PRE_COMMIT_FROM_REF and PRE_COMMIT_TO_REF environment variables."
)
